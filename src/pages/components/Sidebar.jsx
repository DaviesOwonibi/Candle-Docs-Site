...
const Sidebar = () => {
  // Define an array of link objects with 'text' and 'href' properties
  let links = [
    { text: "Home", href: "/", icon: "fa-solid fa-house" },
    { text: "Setting Up", href: "/SettingUp", icon: "fa-solid fa-computer" },
    {
      text: "Input",
      href: "/input",
  ...
  return (
    <nav>
      {/* Map over the 'links' array and generate 'a' tags */}
      <ul className="navbar-nav">
        <div className="logo">
          <a href="./" className="nav-link">
            <span className="link-text">Candle</span>
